...
//	    }
	    ...
	    @PUT
	    @Path("move/{cardTitle}/{listname}")
	    public String move
	    (@PathParam("cardTitle") String cardTitle , @PathParam("listname") String listname )
	    {	
	    	return cardService.changeCardBoard(cardTitle, listname);
	    }
